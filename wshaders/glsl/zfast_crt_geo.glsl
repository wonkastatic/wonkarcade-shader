...
#pragma parameter SCANLINE_WEIGHT "Scanline Amount"     2.0 0.0 15.0 0.5
#pragma parameter MASK_DARK       "Mask Effect Amount"  0.5 0.0 1.0 0.05
#pragma parameter BLURSCALEX "Blur Amount X-Axis" 1.0 0.0 1.0 0.05
#pragma parameter LOWLUMSCAN "Scanline Darkness - Low" 3.0 0.0 10.0 0.5
#pragma parameter HILUMSCAN "Scanline Darkness - High" 8.0 0.0 50.0 1.0
#pragma parameter BRIGHTBOOST "Dark Pixel Brightness Boost" 1.50 0.5 1.5 0.05
